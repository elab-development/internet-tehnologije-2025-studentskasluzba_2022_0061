...
async function main() {
    ...
    const studentNames = [
        { ime: 'Nikola', prezime: 'Nikolić' },
        { ime: 'Jovana', prezime: 'Jovanović' },
        { ime: 'Stefan', prezime: 'Stefanović' },
        { ime: 'Milica', prezime: 'Milić' },
        { ime: 'Luka', prezime: 'Lukić' },
        { ime: 'Ivana', prezime: 'Ivanović' },
        { ime: 'Aleksandar', prezime: 'Aleksandrović' },
        { ime: 'Jelena', prezime: 'Jelenković' },
        { ime: 'Miloš', prezime: 'Milošević' },
        { ime: 'Katarina', prezime: 'Katić' },
        { ime: 'Filip', prezime: 'Filipović' },
        { ime: 'Teodora', prezime: 'Teodorović' },
        { ime: 'Nemanja', prezime: 'Nemanić' },
        { ime: 'Sara', prezime: 'Sarić' },
        { ime: 'Dimitrije', prezime: 'Dimitrijević' },
        { ime: 'Mina', prezime: 'Minić' },
        { ime: 'Vuk', prezime: 'Vuković' },
        { ime: 'Isidora', prezime: 'Isić' },
        { ime: 'Uroš', prezime: 'Urošević' },
        { ime: 'Tamara', prezime: 'Tamarić' },
    ]
